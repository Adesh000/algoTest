        ...
        <>
            <div className="legbuilder_form">
                <div className="number_container leg_div">
                    <label htmlFor="lot-number" className="number_label">
                        Total lot
                    </label>
                    <input
                        type="number"
                ...
                <div className="position_container leg_div">
                    <label htmlFor="position" className="select_label">
                        Position
                    </label>
                ...
                <div className="expiry_container leg_div">
                    <label htmlFor="expiry" className="expiry_label">
                        Expiry
                    </label>
                ...
                <div className="strike_criteria_container leg_div">
                    <label htmlFor="strike-criteria" className="number_label">
                ...
                <div className="strike_type_container leg_div">
                    <label htmlFor="strike-type" className="number_label">
                        Strike Type
                    </label>
